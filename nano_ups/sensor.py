...
DEFAULT_NAME = "Nano UPS"
DEFAULT_ICON = "mdi:battery"
BATTERY_ICON = "mdi:battery"
POWER_PLUG_ICON = "mdi:power-plug"
                        ...
                        try:
                            ...
                            if isinstance(data, dict):
                                ...
                                try:
                                    ...
                                    if line == 1:
                                        line = "POWER PLUG"
                                        self._attributes["icon"] = POWER_PLUG_ICON
                                    else:
                                        line = "BATTERY"
                                        self._attributes["icon"] = BATTERY_ICON
